...
const QuickActions = () =>
{
    ...
    return (
        <div className="mx-auto flex w-full max-w-[270px] justify-center gap-2 rounded-2xl bg-[#202020] px-2 py-1 text-white max-[768px]:max-w-[240px] max-[768px]:gap-1 max-[768px]:px-1.5" dir={direction}>
            <a href={`tel:${EGYPT_PHONE}`} className="z-[1] flex min-w-0 flex-1 cursor-pointer items-center justify-center rounded-xl px-2 py-[7px] transition-all duration-300 hover:bg-[#2a1010] hover:shadow-3xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ef4444]">
            ...
            <a target="_blank" rel="noreferrer" href={buildWhatsappHref(EGYPT_PHONE)} className="z-[1] flex min-w-0 flex-1 cursor-pointer items-center justify-center rounded-xl px-2 py-[7px] transition-all duration-300 hover:bg-[#17351f] hover:shadow-3xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25d366]">
                <span className="flex min-w-0 items-center justify-center gap-1.5">
