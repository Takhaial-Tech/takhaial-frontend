...
const QuickActions = () =>
{
    return (
        <ul className="w-full justify-self-center text-white flex w-fit bg-[#262626] rounded-2xl" >
            <a href="tel:+201500683889" className="z-[1] cursor-pointer hover:shadow-3xl transition-all duration-500 w-[100px] rounded-l pl-[10px] py-[5px] content-center  rounded-s-2xl " style={{ marginRight: "10px" }}>
