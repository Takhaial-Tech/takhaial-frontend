...
const SuccessUi = (props) =>
{
    ...
    return (
        <div id="section_5" className={'min-h-[100vh] relative text-white justify-center items-center pt-[6rem] px-[20px] bg-[#000] z-[1]  relative py-[60px] '} >
            ...
            <div className="md:container md:mx-auto">
                ...
                <div className="z-[10] relative">
                    <div className="lg:ml-[90px] ">
                        <Swiper className='success-slider' slidesPerView={1} onSlideChange={(e) => setActiveStep(e.activeIndex)}>
                                    ...
                                    <div className="flex items-baseline">
                                        ...
                                        {clients.filter(e => e.year === a.year).map((c, key) => (
                                            <div key={key} className={'ml-2 content-center' + (activeStep === k ? 'transition duration-700 delay-' + (key + 2) + '00 opacity-1' : 'opacity-0')}>
                                                <img className="m-auto" alt="" width={60} height={60} src={ c.img} />
                                            </div>
                                        ))}
                                    </div>
                                    <div className="">
